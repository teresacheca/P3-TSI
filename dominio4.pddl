...
;Construir: 
	...
	(:action Reclutar
        ...
        :effect (and 
                    (En ?u ?l)          ; Finalmente, colocaremos la unidad. La localización corresponde con la del edificio donde se reclutan, puesto que al reclutarse, aparecen al lado del edificio
                )
        )
