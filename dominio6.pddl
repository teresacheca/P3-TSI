...
;Construir: 
	...
	; Recolectar:
        ...
        ; asignado a dicho nodo. Además, se debe establecer un límite a la cantidad de recursos almacenados
	    ; es decir, esta acción no se podrá llevar a cabo si la cantidad recolectada más la almacenada previamente exceden el límite de recursos almacenable.
	...
	(:action Recolectar
        ...
        :precondition (and 
            ...
            ; Comprobaremos que al recolectar, no pasamos el límiete. 
            ; El límite tendrá que ser mayo o igual que la cantidad de recurso más 10 por el número de unidades que estén extrayendo ese recurso
            (and
